...
ALTER TABLE TB_ITEMCARDAPIO ADD CONSTRAINT FK_ITEMCARDAPIO_IDITEM FOREIGN KEY (ID_ITEM) REFERENCES TB_ITEM (ID);
...
ALTER TABLE TB_PEDIDO ADD CONSTRAINT FK_PEDIDO_ITEMCARDAPIO FOREIGN KEY (ID_ITEMCARDAPIO) REFERENCES TB_ITEMCARDAPIO (ID);
